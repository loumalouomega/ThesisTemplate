...
%                citestyle=authoryear,
                ...
                maxcitenames=3,
                maxbibnames=100,
                refsection=chapter, %Bibliografia para cada capítulo
                block=none]{biblatex}
    \bibliography{/home/vicente/Dropbox/PhD/Thesis/content/bibliography.bib}
\else
...
& \includegraphics[width=4cm,height=6cm,keepaspectratio]{logos/logo_CIMNE_footer.pdf} \\
    \end{tabular}
    \vfill
    \Huge{Universitat Politècnica de Catalunya-CIMNE}
