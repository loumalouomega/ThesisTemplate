...
\ifx\mydraft Y
  ...
  \csname define@key\endcsname{Gin}{pdfcompress}[]{%
    \epstopdfDeclareGraphicsRule{.pdf}{jpg}{.jpg}{%
      convert -density 300 -background white -alpha background -alpha off -strip -interlace Plane -quality 85 ##1 \OutputFile
%       convert -density 300 -background white -alpha background -alpha off -strip -interlace Plane -gaussian-blur 0.05 -quality 85 ##1 \OutputFile
    }%
  }
\else
...
% \begin{appendices} % Da problemas con bibliografias de capítulo
